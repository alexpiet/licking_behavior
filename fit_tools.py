...
def licking_model(params, licksdt, stop_time, mean_lick_rate=True, dt = 0.01,
    ...
    include_flashes=False, num_flash_params=15,flash_duration=0.76, flash_sigma = 0.025, flashesdt=[],
    include_change_flashes=False, num_change_flash_params=15,change_flash_duration=0.76, change_flash_sigma = 0.025, change_flashesdt=[],
    l2=0):
    '''
