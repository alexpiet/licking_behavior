...
include_flashes=True, num_flash_params=15,flash_duration=0.76, flash_sigma = 0.025, flashesdt=flashesdt, 
include_change_flashes=True, num_change_flash_params=15,change_flash_duration=0.76, change_flash_sigma = 0.025, change_flashesdt=change_flashesdt)
